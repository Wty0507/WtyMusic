...
+ (UIColor *)littleBlack
{
    return [UIColor colorFromHexCode:@"1f1f1f"];
}
+ (UIColor *)myBlueColor
{
    return [UIColor colorFromHexCode:@"1786fc"];
}

+ (UIColor *)staGreen
{
    return [UIColor colorFromHexCode:@"6b9f1f"];
}

+ (UIColor *)navGreen
{
    return [UIColor colorFromHexCode:@"8fc32e"];
}
+ (UIColor *)readBgColor
{
...
{
    return [UIColor colorFromHexCode:@"84AC55"];
}
